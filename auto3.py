...
autoencoder.compile(optimizer=Adam(learning_rate=0.0001), loss='mse')  # Adjust learning rate and loss function
...
input_image_path = 'C:/Desktop/IOT_Pro/gandataset/test2.jpg'
